  ...
  <div className="max-w-7xl mx-auto p-50 grid grid-cols-1 lg:grid-cols-2 rounded-[4rem] overflow-hidden shadow-2xl bg-white border border-[#1b4c53]/5">
    ...
    <div className="p-12 lg:p-20 bg-[#1b4c53] text-[#f9faed] flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
        <svg width="100%" height="100%"><defs><pattern id="mapGrid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="#f9faed" strokeWidth="0.5"/></pattern></defs><rect width="100%" height="100%" fill="url(#mapGrid)" /></svg>
      </div>
      ...
      <div className="relative z-10">
        ...
        >
          <span className="w-2 h-2 rounded-full bg-[#3a7e88] animate-pulse" /> Global Headquarters
        </motion.div>

        <h2 className="text-5xl font-black mb-12 tracking-tighter uppercase italic leading-none">
          Visit Our <br /> <span className="text-[#3a7e88] not-italic font-light">Nexus.</span>
        </h2>
        ...
        <div className="space-y-10">
          ...
          <div className="flex gap-6 group cursor-pointer">
            <div className="w-14 h-14 flex items-center justify-center group-hover:bg-[#3a7e88] transition-all duration-500">
              <MapPin size={24} className="text-[#3a7e88] group-hover:text-[#f9faed]" />
            </div>
            <div>
              <h4 className="text-xs font-black uppercase tracking-widest text-[#3a7e88] mb-1">{"USA Office (Headquarter)"}</h4>
              <p className="text-xl font-medium opacity-80 leading-snug">
                30 N Gould St Ste R, Sheridan,<br /> WY 82801
              </p>
            </div>
             <div>
              <h4 className="text-xs font-black uppercase tracking-widest text-[#3a7e88] mb-1">Indian Office</h4>
              <p className="text-xl font-medium opacity-80 leading-snug">
                Arocon, Noida<br />Sector 125, Uttar Pradesh 201313
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-6 group cursor-pointer">
              <div className="w-14 h-14 flex items-center justify-center group-hover:bg-[#3a7e88] transition-all duration-500">
                <Mail size={24} className="text-[#3a7e88] group-hover:text-[#f9faed]" />
              </div>
              <div>
                <h4 className="text-xs font-black uppercase tracking-widest text-[#3a7e88] mb-1">Email Sync</h4>
                <p className="text-lg font-bold break-all">contact@kaashtech.com</p>
              </div>
            </div>
    ...
    <div className="relative h-[500px] lg:h-auto bg-[#f9faed] overflow-hidden">
      ...
      <div className="absolute top-8 left-8 bg-[#1b4c53] p-4 rounded-2xl shadow-xl border border-white/10 flex items-center gap-4">
         ...
         <div>
            <span className="block text-[10px] font-black uppercase tracking-tighter text-[#f9faed]">Real-time Status</span>
            <span className="text-[10px] text-[#3a7e88] font-bold">Location: Active</span>
         </div>
      </div>
    </div>
  </div>
