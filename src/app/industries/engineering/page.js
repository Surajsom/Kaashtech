      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] opacity-[0.08]">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            <motion.circle
              cx="50" cy="50" r="48"
              stroke="#1b4c53" strokeWidth="0.2" fill="none"
      ...
      <div className="relative z-10">
        ...
        <section className="relative h-screen flex items-center justify-center px-6">
          <div className="relative z-10 text-center max-w-4xl">
            ...
            >
              <Compass size={14} className="inline mr-2" /> Precision Technical Delivery
            </motion.div>
            <h1 className="text-7xl md:text-[10rem] font-black text-[#1b4c53] leading-none tracking-tighter">
              SOLVE <br /> <span className="italic font-light text-[#3a7e88]">BUILT.</span>
            </h1>
            <p className="mt-10 text-xl font-[Urbanist] md:mb-12 text-[#1b4c53]/70 font-medium max-w-xl mx-auto leading-relaxed">
              ...
              solutions that withstand the test of time and environmental forces.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
              ...
              >
                ...
                <p className="text-[#f9faed]/60 text-lg leading-relaxed mb-10 font-[Urbanist]">
                  Modern engineering requires a fusion of hardware reliability and 
                  software intelligence. We provide the expertise to optimize your 
                  infrastructure, reduce material waste, and increase mechanical efficiency.
                </p>
                <div className="flex items-center gap-4 text-[#f9faed] bg-white/5 p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                   ...
                   <span className="font-bold text-xl italic tracking-tight ">Micron-Level Accuracy Standards</span>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {pillars.map((item, i) => (
                  ...
                  >
                    ...
                    <item.icon className="text-[#3a7e88] mb-6 group-hover:text-[#f9faed] transition-colors relative z-10" size={40} />
                    <h4 className="text-[#f9faed] text-2xl font-bold mb-4 tracking-tight relative z-10">{item.title}</h4>
                    <p className="text-[#f9faed]/40 text-sm leading-relaxed relative z-10 font-[Urbanist]">{item.desc}</p>
                  </motion.div>
                ))}
              </div>
            </div>
        ...
        <section className="py-32 px-6 bg-[#f9faed]">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-24">
              <h2 className="text-[#1b4c53] text-4xl md:text-6xl font-black tracking-tighter italic">DRAFT. SIMULATE. CONSTRUCT.</h2>
            </div>
              ...
              {[
                {
                  ...
                  detail: "Utilizing advanced Finite Element Analysis to predict how products react to real-world forces, vibration, heat, and fluid flow.",
                },
                {
                  title: "Sustainable Infrastructure",
                  detail: "Engineering solutions focused on longevity and energy efficiency, reducing the total carbon footprint of industrial operations.",
                },
              ].map((card, i) => (
                <motion.div
                  key={i}
