      ...
      <section className="pb-32 md:px-6 px-4">
        ...
        >
          ...
          <motion.button 
            ...
            className=" inline-flex items-center md:gap-4 gap-2 cursor-pointer bg-[#f9faed] text-[#1b4c53] md:px-14 md:py-7 px-10 py-4 rounded-full font-black text-sm md:text-xl hover:shadow-[0_0_40px_rgba(249,250,237,0.2)] transition-all group"
          >
