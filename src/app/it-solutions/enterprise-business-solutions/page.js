...
export default function EnterpriseBusinessSolutionsPage() {
  ...
  return (
    <div className="bg-[#f9faed] min-h-screen md:py-12 selection:bg-[#1b4c53] selection:text-white font-sans">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <p className="mt-10 font-[Urbanist] md:mt-3 md:mb-25 text-xl text-[#1b4c53]/70 font-medium max-w-xl mx-auto leading-relaxed">
