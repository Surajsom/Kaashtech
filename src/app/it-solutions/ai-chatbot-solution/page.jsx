...
export default function AIChatbotPage() {
  return (
    <div className="bg-[#f9faed] min-h-screen font-sans selection:bg-[#1b4c53] selection:text-white">
      ...
      {/* FINAL CTA SECTION */}
      <section className="bg-[#1b4c53] pb-32 px-6">
        <div className="max-w-5xl mx-auto bg-[#f9faed] rounded-[4rem] p-20 text-center shadow-2xl">
          <Bot className="mx-auto mb-8 w-16 h-16 text-[#1b4c53]" />
          <h2 className="text-[#1b4c53] text-5xl md:text-7xl font-bold tracking-tighter mb-8">
            Ready to <br /> Automate?
          </h2>
          <button className="bg-[#1b4c53] text-[#f9faed] px-12 py-6 rounded-full font-black text-xl hover:scale-105 transition-transform flex items-center gap-4 mx-auto">
