...
const pillars = [
  { 
    ...
    icon: Search, 
    desc: "Precision keyword targeting and technical optimization to dominate search engine results." 
  },
  { 
    title: "Precision PPC", 
    icon: MousePointerClick, 
    desc: "High-ROI paid campaigns across Google, Meta, and LinkedIn that convert clicks into customers." 
  },
  { 
    title: "Content Strategy", 
    icon: Share2, 
    desc: "Compelling storytelling and multimedia content that builds brand authority and community." 
  },
  { 
    title: "Social Growth", 
    icon: Globe, 
    desc: "Data-driven social media management to expand your reach and foster authentic engagement." 
  },
];
...
export default function DigitalMarketingPage() {
  ...
  return (
    <div className="bg-[#f9faed] min-h-screen md:py-6 selection:bg-[#1b4c53] selection:text-white font-sans">
      
      {/* 1. HERO SECTION - THE AMPLIFICATION */}
      ...
      {/* 2. THE DEEP GREEN SECTION - THE CONVERSION ENGINE */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
            ...
            >
              <h2 className="text-5xl md:text-7xl font-bold text-[#f9faed] leading-tight mb-8">
                Data-Led <br /> Creativity.
              </h2>
              <div className="w-24 h-1 bg-[#3a7e88] mb-10" />
              <p className="text-[#f9faed]/60 text-lg leading-relaxed mb-10 font-[Urbanist]">
                Marketing is no longer a guessing game. We combine creative storytelling with rigorous data analysis to ensure every dollar of your budget drives measurable results.
              </p>
              <div className="flex items-center gap-4 text-[#f9faed] bg-white/5 p-6 rounded-2xl border border-white/10">
                 <Zap className="text-[#3a7e88]" size={32} />
                 <span className="font-bold text-xl italic tracking-tight">Rapid Response Marketing Framework</span>
              </div>
            </motion.div>
      ...
      {/* 3. LIGHTING BORDER CARDS - STRATEGIC CHANNELS */}
      <section className="py-32 px-6 bg-[#f9faed]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-[#1b4c53] text-4xl md:text-6xl font-black tracking-tighter italic">REACH. RETAIN. REVENUE.</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              {
                title: "Inbound Ecosystems",
                detail: "We build digital funnels that naturally attract high-intent leads through educational content and technical authority.",
              },
              {
                title: "Multi-Channel Sync",
                detail: "Ensure your brand message remains consistent across Search, Social, and Email for a seamless customer journey.",
              },
            ].map((card, i) => (
              <motion.div
                key={i}
      ...
      <section className="pb-32 px-6">
        ...
        >
          <Megaphone className="mx-auto mb-10 w-20 h-20 text-[#3a7e88] opacity-50" />
          <h2 className="text-5xl md:text-8xl font-bold mb-10 tracking-tighter">
            Amplify <br /> Your Vision.
          </h2>
          <motion.button 
