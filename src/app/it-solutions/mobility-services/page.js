...
export default function MobilityServicesPage() {
  ...
  return (
    <div className="bg-[#f9faed] min-h-screen selection:bg-[#1b4c53] selection:text-white font-sans">
      ...
      <section className="relative h-screen flex pt-5 items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <p className="mt-6 font-[Urbanist] md:mt-2 text-xl md:mb-22 text-[#1b4c53]/70 font-medium max-w-xl mx-auto leading-relaxed">
