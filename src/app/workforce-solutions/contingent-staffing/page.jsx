    ...
    <div className="bg-[#f9faed] min-h-screen selection:bg-[#1b4c53] selection:text-white">
      ...
      />
        <motion.div
          ...
          className="absolute bottom-10 left-[-10%] w-[400px] h-[400px] bg-[#1b4c53]/5 rounded-full blur-3xl"
        />
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <p className="mt-8 text-xl text-[#1b4c53]/70 font-medium max-w-lg mx-auto">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {pillars.map((item, i) => (
                <div key={i}>
                  {/* Notice the uppercase 'I' to treat it as a component */}
                 <item.icon size={32} className="text-[#f9faed] mb-4" />
                  {/* <item.icon size={32} className="text-[#f9faed]" /> */}
      ...
      {/* 3. INTERACTIVE KEY POINTS (THE LIGHTING BORDER) */}
            ...
            {[
              {
                title: "Dynamic Bench",
                detail:
                  "Active access to specialized developers, designers, and managers.",
              },
              {
                title: "Cost Efficiency",
                detail:
                  "Reduce fixed costs by 30% by paying only for active project hours.",
              },
            ].map((card, i) => (
              <motion.div
                key={i}
      ...
      {/* 4. FINAL CTA SECTION (CLEAN & BOLD) */}
