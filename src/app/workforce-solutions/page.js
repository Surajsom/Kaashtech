...
const workforceServices = [
  { name: "Contingent Staffing", icon: Zap, path: "/workforce-solutions/contingent-staffing", desc: "Agile, on-demand talent for rapid project scaling and market fluctuations." },
  { name: "Direct Hire & Executive Search", icon: UserCheck, path: "/workforce-solutions/direct-hire", desc: "Precision placement for long-term leadership and specialized technical roles." },
  { name: "Global Payroll & Compliance", icon: Globe, path: "/workforce-solutions/global-payroll-and-compliance", desc: "Zero-risk international employment management and tax legalities." },
  { name: "Direct Sourcing", icon: Magnet, path: "/workforce-solutions/direct-sourcing", desc: "Leveraging your brand to attract and curate a private talent community." },
  { name: "Statement of Work (SOW)", icon: FileText, path: "/workforce-solutions/statement-of-work-sow", desc: "Project-based deliverables management with defined milestones and outcomes." },
  { name: "Nearshore & Offshore Solutions", icon: Navigation, path: "/workforce-solutions/nearshore-and-offshore-solutions", desc: "Strategic geographic talent distribution for cost and time-zone optimization." },
  { name: "Recruitment Process Outsourcing", icon: Activity, path: "/workforce-solutions/recruitment-process-outsourcing-rpo", desc: "Full-cycle recruitment management to reduce time-to-hire and overhead." },
];
    ...
    <div className="bg-[#f9faed] min-h-screen py-10 selection:bg-[#1b4c53] selection:text-white font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-[0.05] z-0">
        <svg width="100%" height="100%">
          <pattern id="humanGrid" width="120" height="120" patternUnits="userSpaceOnUse">
            <circle cx="60" cy="60" r="1.5" fill="#1b4c53" />
            <motion.circle 
              cx="60" cy="60" r="30" 
              fill="none" stroke="#1b4c53" strokeWidth="0.2"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 lg:py-40">
        ...
        <div className="text-center mb-32">
          ...
          <h1 className="text-7xl md:text-[10rem] font-black text-[#1b4c53] leading-none tracking-tighter uppercase">
            Global <br /> <span className="italic font-light text-[#3a7e88]">Talent.</span>
          </h1>
                ...
                <div className="relative bg-white p-12 rounded-[3.4rem] h-full shadow-sm flex flex-col justify-between border border-[#1b4c53]/5 group-hover:border-transparent transition-colors">
                  <div>
                    <div className="w-16 h-16 bg-[#f9faed] rounded-2xl flex items-center justify-center mb-8 border border-[#1b4c53]/5 group-hover:bg-[#1b4c53] transition-all duration-500">
                      <service.icon className="text-[#3a7e88] group-hover:text-[#f9faed] transition-colors" size={32} />
                    </div>
      ...
      {/* FINAL CTA SECTION */}
      <section className="pb-40 px-6 mt-10">
        <motion.div
        ...
        >
          <div className="relative z-10">
            <Briefcase size={64} className="mx-auto mb-10 text-[#3a7e88] opacity-50" />
            <h2 className="text-5xl md:text-[9rem] font-black mb-12 tracking-tighter leading-none uppercase">
              Activate your <br /> <span className="italic font-light text-[#3a7e88]">Edge.</span>
            </h2>
            <p className="text-[#f9faed]/40 text-xl mb-16 max-w-xl mx-auto font-medium">
              Join the elite enterprises scaling with precision. 
              Get your custom workforce strategy in 24 hours.
            </p>
