    ...
    <div className="bg-[#f9faed] min-h-screen selection:bg-[#1b4c53] selection:text-white font-sans">
      ...
      <section className="pb-32 px-6">
        <motion.div
          ...
          className="max-w-6xl mx-auto bg-[#1b4c53] rounded-[5rem] p-24 text-center text-[#f9faed] relative overflow-hidden"
        >
          {/* Subtle Glow Overlay */}
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-4 bg-[#f9faed] text-[#1b4c53] px-14 py-7 rounded-full font-black text-xl hover:shadow-[0_0_40px_rgba(249,250,237,0.2)] transition-all group"
          >
