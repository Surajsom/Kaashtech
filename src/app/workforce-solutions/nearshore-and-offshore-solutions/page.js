                ...
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#f9faed]/50 text-sm leading-relaxed font-[Urbanist]">{item.text}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="pb-32 px-6">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-4 bg-[#f9faed] text-[#1b4c53] md:px-14 md:py-7 px-4 py-8 rounded-full font-black md:text-md text-lg group shadow-2xl transition-all"
          >
