    ...
    <div className="bg-[#f9faed] min-h-screen selection:bg-[#1b4c53] selection:text-white">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <p className="mt-8 text-xl text-[#1b4c53]/70 font-medium max-w-xl mx-auto leading-relaxed">
      ...
      <section className="py-32 px-6 bg-[#f9faed]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-6">
            <h2 className="text-[#1b4c53] text-5xl font-black tracking-tighter">THE CORE <br /> ASSURANCE.</h2>
            <p className="text-[#1b4c53]/60 max-w-xs font-medium text-right italic">Built for the modern, distributed world.</p>
          </div>
      ...
      <section className="pb-32 px-6">
        ...
        >
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-4 bg-[#f9faed] text-[#1b4c53] px-12 py-6 rounded-full font-black text-xl cursor-pointer shadow-xl group"
          >
