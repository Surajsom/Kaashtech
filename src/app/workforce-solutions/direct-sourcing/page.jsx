    ...
    <div className="bg-[#f9faed] min-h-screen selection:bg-[#1b4c53] selection:text-white">
      ...
      <section className="pb-32 px-6">
        ...
        >
          ...
          <p className="text-[#f9faed]/60 text-xl mb-12 max-w-xl mx-auto font-medium leading-relaxed">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-3 bg-[#f9faed] text-[#1b4c53] px-12 py-6 rounded-full font-black text-xl hover:shadow-[0_0_30px_rgba(249,250,237,0.3)] transition-all group"
          >
