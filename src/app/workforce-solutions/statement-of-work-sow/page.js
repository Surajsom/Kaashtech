...
export default function SOWPage() {
  ...
  return (
    <div className="bg-[#f9faed] py-8 min-h-screen selection:bg-[#1b4c53] selection:text-white font-sans">
      ...
      <section className="relative flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-5xl">
          ...
          <p className="mt-10 font-[Urbanist] mb-14 text-xl text-[#1b4c53]/70 font-medium max-w-xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {pillars.map((item, i) => (
                ...
                >
                  ...
                  <p className="text-[#f9faed]/40 text-sm leading-relaxed font-light font-[Urbanist]">{item.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
